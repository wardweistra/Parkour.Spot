...
class AppLocalizationsDe extends AppLocalizations {
  ...
  @override
  String get spotCardNoImages => 'Keine Bilder';
  ...
  String spotCheckInTooltipPublic(String name, String time) {
    return '$name ist gerade an diesem Spot (bis $time)';
  }

  @override
  String spotCheckInTooltipPrivate(String time) {
    return 'Du bist gerade an diesem Spot bis $time — nur du siehst diesen Check-in';
  }
  ...
  String get spotDetailCommunitySectionSubtitle =>
      'Sieh, wer hier trainiert, und teile deine Session.';
  ...
  @override
  String get spotDetailCommunityPlanningVisitButton => 'Plane einen Besuch';

  @override
  String get spotDetailCommunityPlanningVisitTooltip =>
      'Demnächst — sag der Community, wann du hier trainieren willst.';
  ...
  String spotDetailAlsoBasedOnCount(int count) {
    return 'Außerdem basierend auf ($count)';
  }

  @override
  String get spotDetailNoImagesAvailable => 'Keine Bilder verfügbar';
  ...
  String get myCheckInsSignInPrompt =>
      'Melde dich an, um deine Check-ins zu sehen';

  @override
  String get myCheckInsLoadMore => 'Mehr laden';

  @override
  String get myCheckInsEmptyTitle => 'Noch keine Check-ins';

  @override
  String get myCheckInsEmptyDescription =>
      'Öffne einen Spot und tippe auf „Einchecken“, um einen Besuch zu speichern. Bis zur von dir gesetzten Endzeit sehen andere dich dort als „gerade hier“, sofern dein Check-in nicht privat ist.';

  @override
  String get myCheckInsIntro =>
      'Ein Check-in speichert, dass du einen Spot besucht hast, wann du angekommen bist und bis wann du voraussichtlich dort bist. Öffentliche Check-ins können dich bis zu dieser Endzeit bei „Wer ist gerade hier“ anzeigen; private Check-ins sind nur für dich sichtbar.';
