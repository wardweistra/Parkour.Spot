...
class AppLocalizationsFr extends AppLocalizations {
  ...
  String get profileLocationAlertsNotifyNewSpotsSubtitle =>
      'Recevez une notification in-app lorsqu’un spot est ajouté à environ 5 km d’un lieu enregistré actif ou de votre dernière position connue.';
  ...
  @override
  String get profileHelpTranslate => 'Aider à traduire l’application';
  ...
  String get addHubSubtitle =>
      'Les spots sont publiés immédiatement. Les événements sont d\'abord examinés par les modérateurs.';
  ...
  String get addHubSpotDescription =>
      'Partagez un nouveau spot d\'entraînement avec photos et détails.';

  @override
  String get addHubSpotButton => 'Créer un spot';

  @override
  String get addHubEventTitle => 'Ajouter un événement';

  @override
  String get addHubEventDescription =>
      'Soumettez une proposition d\'événement. Les modérateurs l\'approuvent ou la rejettent.';
  ...
  @override
  String get addSpotCreating => 'Création du spot…';

  @override
  String get addSpotCreateButton => 'Créer le spot';
  ...
  String get addEventModerationNotice =>
      'Les propositions d\'événements sont examinées par les modérateurs avant d\'être rendues publiques.';
  ...
  String get addEventPhotosSectionTitle =>
      'Photos de l\'événement (facultatif)';
  ...
  String get addEventLocationSectionHint =>
      'Ajoutez un ou plusieurs spots et/ou un emplacement exact pour l\'événement.';
  ...
  String get addEventNeedLocationOrLink =>
      'Ajoutez un emplacement sur la carte, liez un spot ou une liste de spots avant de soumettre.';
  ...
  @override
  String get spotDetailSelectSections => 'Sélectionner les sections :';
  ...
  String get spotDetailSelectListsPrompt =>
      'Sélectionnez les listes auxquelles ajouter ce spot :';
  ...
  @override
  String get spotDetailListDescriptionLabel => 'Description (optionnelle)';
  ...
  String get spotDetailReportCategoryInaccurate =>
      'Emplacement ou infos incorrects';
  ...
  String get spotDetailReportCategoryInaccurateDesc =>
      'La position sur la carte est incorrecte ou le nom, la description ou l’adresse sont erronés. Indiquez ci-dessous ce qu’il faut corriger.';
  ...
  String get spotListSaveSignInBody =>
      'Enregistrez la liste de spots de quelqu\'un dans votre profil pour pouvoir la rouvrir plus tard.';

  @override
  String get spotListSaveSavedToProfile =>
      'Liste enregistrée dans votre profil';
  ...
  String get spotListDetailMoreInfoLinkLabel =>
      'Lien d\'infos supplémentaires (optionnel)';
  ...
  @override
  String get spotListDetailMenuListSettings => 'Paramètres de la liste';

  @override
  String get spotListDetailMenuOrganizeList => 'Organiser la liste';
  ...
  @override
  String get detailUpcomingEventLabel => 'Événement à venir';

  @override
  String get detailUpcomingEventOpen => 'Ouvrir';
